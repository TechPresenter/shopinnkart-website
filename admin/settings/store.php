...
$spec = [
    ...
    'timezone' => [
        ...
        'help' => 'Every timestamp in the admin and on invoices.',
    ],
    'products_per_page' => [
        'type' => 'number', 'label' => 'Products per page', 'required' => true,
        'min_value' => 4, 'max_value' => 96,
        'help' => 'Shop, category and brand grids.',
    ],
    'low_stock_threshold' => [
        'type' => 'number', 'label' => 'Default low stock threshold', 'required' => true,
        'min_value' => 0, 'max_value' => 9999,
        'help' => 'Used when a product sets none. Drives the "Only n left" badge.',
    ],
    'max_compare_items' => [
        'type' => 'number', 'label' => 'Max compare items', 'required' => true,
        // How many products fit side by side on /compare.
        ...
        'help' => 'Also on the Widgets tab — the same setting, not a second one.',
    ],
    'guest_checkout' => [
        'type' => 'bool', 'label' => 'Allow guest checkout',
        'help' => 'Off forces sign-in before checkout.',
    ],
    ...
    'order_prefix' => [
        ...
        'group' => 'order',
        'help' => 'Prefix + date + six random characters, so they cannot be counted.',
    ],
    'invoice_prefix' => [
    ...
    'auto_confirm_cod' => [
        ...
        'help' => 'New COD orders skip Pending.',
    ],
];
            ...
            <div class="ad-card__head">
                <div>
                    ...
                    <div class="ad-card__sub">
                        Every price on the site, formatted now as <?= e(money(124999)) ?>.
                    </div>
                </div>
            </div>
        ...
        <div class="ad-card" style="margin:0">
            <div class="ad-card__head">
                <div>
                    ...
                    <div class="ad-card__sub">Vendor, language and currency support.</div>
                </div>
            </div>
